...
\section{教育背景}
\cventry{2009/09 -- 现在}{硕博连读研究生}{中国科学院上海生命科学研究院计算生物学研究所}{上海}{}{计算生物学专业，生物学中的模式识别研究组，生物医学图像处理方向} % 第3到第6编码可留白
\eduseparator
\cventry{2012/12 -- 2013/09}{联合培养博士生}{波鸿鲁尔大学}{德国波鸿}{}{生物物理系生物信息学研究组}
\eduseparator
\cventry{2011/06 -- 2011/07}{访问学生}{波鸿鲁尔大学}{德国波鸿}{}{生物物理系生物信息学研究组}
\eduseparator
\cventry{2005/09 -- 2009/06}{理学学士}{南京大学生命科学学院}{南京}{}{生物技术专业}
...
\cvitem{编程}{精通Matlab、C/C++，熟悉Python、Ruby、Shell以及OpenCV库。}
\cvitem{系统管理}{多年的Linux（桌面和服务器）使用经验，Arch Linux粉丝；在VPS上配置管理过Web服务器，数据库服务器等；熟悉并喜爱Linux下的开发工具（Git，Vim，Make，Screen等）；Linux系统管理员一直是我的理想职业。}
